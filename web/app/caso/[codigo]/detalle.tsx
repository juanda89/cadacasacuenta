...
/** La vista completa del caso: SOLO se renderiza tras verificación OTP. */
export default async function DetalleCaso({ codigo }: { codigo: string }) {
    ...
    <>
      ...
      <section style={{ background: "var(--bruma)", borderBottom: "1px solid var(--borde-papel)" }}>
        <div className="contenedor" style={{ padding: "40px 24px 34px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 28, alignItems: "flex-end", justifyContent: "space-between" }}>
            <div>
              <span className="kicker" style={{ color: "var(--aguacero)" }}>Su caso — vista verificada ✓</span>
      ...
      <main className="contenedor" style={{ padding: "36px 24px 72px" }}>
        ...
        <p style={{ fontSize: ".8rem", color: "var(--arcilla)", marginTop: 30, maxWidth: "70ch" }}>
          Esta vista se abrió verificando su número de WhatsApp y solo la ve usted (y los profesionales
          del caso). Los datos se tratan conforme a la <a href="/datos">política de tratamiento de datos</a>{" "}
          (Ley 1581 de 2012).
        </p>
      </main>
    </>
